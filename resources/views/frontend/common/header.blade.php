<div class="header_section">
    <div class="container-fluid header_main">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="logo" href="{{route('blog.home')}}"><img style="width: 80px; margin-left: 20px" src="{{asset('frontend/images/blog_home.png')}}"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><img src="{{asset('frontend/images/serach-icon.png')}}"></a>
                    </li>
                </ul>
            </div>
        </nav>
