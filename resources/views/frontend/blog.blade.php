        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="about_img"><img src="{{asset('frontend/images/img-8.png')}}"></div>
                    <div class="like_icon"><img src="{{asset('images/like-icon.png')}}"></div>
                ...
                <div class="col-lg-4 col-sm-12">
                    <div class="about_main">
                        ...
                        <div class="follow_icon">
                            <ul>
                                <li><a href="#"><img src="{{asset('frontend/images/fb-icon-1.png')}}"></a></li>
                                <li><a href="#"><img src="{{asset('frontend/images/twitter-icon-1.png')}}"></a></li>
                                <li><a href="#"><img src="{{asset('frontend/images/linkedin-icon-1.png')}}"></a></li>
                                <li><a href="#"><img src="{{asset('frontend/images/instagram-icon-1.png')}}"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
